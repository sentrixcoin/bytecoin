...
const uint64_t MONEY_SUPPLY                                  = static_cast<uint64_t>(1888888880000000);
...
const char     CRYPTONOTE_NAME[]                             = "sentrixcoin";
...
const int      P2P_DEFAULT_PORT                              =  19325;
const int      RPC_DEFAULT_PORT                              =  18325;
